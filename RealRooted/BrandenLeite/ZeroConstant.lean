  ...
  · obtain ⟨a, ha_pf, ha0pos, halim⟩ :=
    ...
    · intro n
      apply interl_of_pf_coeff_tendsto_of_natDegree_le
        ...
        (fun k => interl_compositionRow_positivePartSeries_succ
          (ha_pf k) (ha0pos k) n)
...
@[deprecated compositionRows_positivePartSeries_pf_and_interl
  (since := "2026-09-18")]
alias compositionRows_positivePartSeries_pf_and_prec0 :=
  compositionRows_positivePartSeries_pf_and_interl
...
theorem compositionRows_mk_pf_and_interl_of_zero
  ...
  exact compositionRows_positivePartSeries_pf_and_interl hf

@[deprecated compositionRows_mk_pf_and_interl_of_zero (since := "2026-09-18")]
alias compositionRows_mk_pf_and_prec0_of_zero := compositionRows_mk_pf_and_interl_of_zero
...
theorem interl_compositionRow_mk_succ_of_zero
  ...
  (compositionRows_mk_pf_and_interl_of_zero hf hf0).2 n

@[deprecated interl_compositionRow_mk_succ_of_zero (since := "2026-09-18")]
alias prec0_compositionRow_mk_succ_of_zero := interl_compositionRow_mk_succ_of_zero
