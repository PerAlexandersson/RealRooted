...
lemma roots_nonpos_stirlingPermutations_of_isRealRooted {n : Nat}
    (hrr : IsRealRooted (stirlingPermutations n)) :
...
lemma prec_stirlingPermutations_one_two :
  ...
  have hf : IsRealRooted (stirlingPermutations 1) := isRealRooted_of_degree_one hdeg
  have hInter :
...
theorem prec_stirlingPermutations_succ :
  ...
  | n + 2 => by
      have hf : IsRealRooted (stirlingPermutations (n + 2)) :=
...
theorem isRealRooted_stirlingPermutations :
    ∀ n : Nat, IsRealRooted (stirlingPermutations n)
  | 0 => by
