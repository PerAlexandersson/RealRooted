...
/-!
# Mixed adjacent Euler compatibility

This file proves compatibility between the two adjacent Euler insertion
operators used for derangement descent polynomials. The reusable operator API
lives in `EulerianMixedCompatibility.Insertion`; this module owns the mixed
partial-fraction, regularization, and common-root-safe arguments.
...
private theorem mixedEulerStep_prec_of_no_common
  ...
  have hbase : StrictInterl h ((X - C u) * h) :=
    strictInterl_self_X_sub_C_mul hh_ne hh_splits u
