...
This compatibility module retains the theorem-route layers for the direct
Garloff--Wagner proof. The factorial and differential algebra lives in the
focused `GarloffWagner.Algebra` child and remains available through this path.
-/
