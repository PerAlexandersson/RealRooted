...
theorem exists_kreinSummand_factor_of_isRoot {g : ℝ[X]} (hg0 : g ≠ 0)
  ...
  exact ⟨q, r, hfactor, rfl, hr_nodvd, eval_ne_zero_of_not_dvd_X_sub_C hr_nodvd,
...
is again PF.  This is the deletion step for the Theorem 12 induction. -/
theorem IsPFPolynomial.of_X_sub_C_mul_factor {p q : ℝ[X]} {u : ℝ}
...
theorem IsPFPolynomial.exists_X_sub_C_factor_of_pos_natDegree {p : ℝ[X]}
