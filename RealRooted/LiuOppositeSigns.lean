...
This compatibility module extends the root-count foundation in
`RealRooted.LiuOppositeSigns.RootCount` with positive-leading normalization,
largest-root deletion lemmas, and the left/right branches used in Lily L.
Liu's opposite-leading-sign compatibility criterion.
-/
