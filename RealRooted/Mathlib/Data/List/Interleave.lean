...
lemma interleave_append_append_of_length_eq_length :
  ...
  | [], [], _, l₃, l₄ => by simp
  | a :: l₁, b :: l₂, _, l₃, l₄ => by
      simp_all [interleave_append_append_of_length_eq_length]

@[simp]
lemma interleave_append_left_of_length_eq_length
...
@[simp]
lemma interleave_append_right_of_length_eq_length
    (h₁₂ : l₁.length = l₂.length) (l₃ : List α) :
...
lemma interleave_append_left_of_length_add_one_eq_length (h₁₂ : l₁.length + 1 = l₂.length)
    (l₃ : List α) :
    (l₁ ++ l₃).interleave l₂ = l₁.interleave l₂ ++ [].interleave l₃ := by
...
lemma interleave_append_right_of_length_add_one_eq_length (h₁₂ : l₁.length + 1 = l₂.length)
    (l₃ : List α) :
    l₁.interleave (l₂ ++ l₃) = l₁.interleave l₂ ++ l₃.interleave [] := by
  simpa using interleave_append_append_of_length_add_one_eq_length h₁₂ [] _
...
lemma interleaves_reverse_reverse_of_length_add_one_eq_length (h : l₁.length + 1 = l₂.length) :
  Interleaves r l₁.reverse l₂.reverse ↔ Interleaves (Function.swap r) l₁ l₂ := by
  simp [interleaves_iff_length_isChain_interleave,
    ← reverse_interleave_of_length_add_one_eq_length,
    isChain_reverse, *]
