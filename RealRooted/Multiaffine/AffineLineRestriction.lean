...
theorem MvPolynomial.IsMultiaffine.coordinateWronskian_eq_specializeZero
    {σ : Type*} {P Q : MvPolynomial σ ℝ}
    (hP : P.IsMultiaffine) (hQ : Q.IsMultiaffine) (i : σ) :
    MvPolynomial.coordinateWronskian P Q i =
      MvPolynomial.specializeZero i P * MvPolynomial.pderiv i Q -
        MvPolynomial.pderiv i P * MvPolynomial.specializeZero i Q := by
  have hPdecomp :=
    MvPolynomial.IsMultiaffine.eq_specializeZero_add_X_mul_pderiv hP i
  have hQdecomp :=
    MvPolynomial.IsMultiaffine.eq_specializeZero_add_X_mul_pderiv hQ i
...
theorem MvPolynomial.IsMultiaffine.notMem_vars_coordinateWronskian
    {σ : Type*} {P Q : MvPolynomial σ ℝ}
    (hP : P.IsMultiaffine) (hQ : Q.IsMultiaffine) (i : σ) :
    i ∉ (MvPolynomial.coordinateWronskian P Q i).vars := by
  classical
  have hiP0 : i ∉ (MvPolynomial.specializeZero i P).vars := by
    intro hi
    have hiErase := MvPolynomial.vars_specializeZero_subset_erase P i hi
    exact (Finset.mem_erase.mp hiErase).1 rfl
  have hiQ0 : i ∉ (MvPolynomial.specializeZero i Q).vars := by
    intro hi
    have hiErase := MvPolynomial.vars_specializeZero_subset_erase Q i hi
    exact (Finset.mem_erase.mp hiErase).1 rfl
  ...
  have hiLeft : i ∉ (MvPolynomial.specializeZero i P *
      MvPolynomial.pderiv i Q).vars := by
    intro hi
    exact (Finset.mem_union.mp (MvPolynomial.vars_mul _ _ hi)).elim
      hiP0 hiQi
  have hiRight : i ∉ (MvPolynomial.pderiv i P *
      MvPolynomial.specializeZero i Q).vars := by
    intro hi
    exact (Finset.mem_union.mp (MvPolynomial.vars_mul _ _ hi)).elim
      hiPi hiQ0
  ...
  exact (Finset.mem_union.mp
    (MvPolynomial.vars_sub_subset
      (p := MvPolynomial.specializeZero i P * MvPolynomial.pderiv i Q)
      (q := MvPolynomial.pderiv i P * MvPolynomial.specializeZero i Q)
      hi)).elim hiLeft hiRight

/-- Scalar specialization of a multiaffine polynomial is the affine pencil
generated by its zero-specialization and partial derivative. -/
theorem MvPolynomial.IsMultiaffine.specializeAt_eq_specializeZero_add_C_mul_pderiv
    {σ : Type*} {P : MvPolynomial σ ℝ}
    (hP : P.IsMultiaffine) (i : σ) (c : ℝ) :
    MvPolynomial.specializeAt i c P =
      MvPolynomial.specializeZero i P +
        MvPolynomial.C c * MvPolynomial.pderiv i P := by
  classical
  apply MvPolynomial.funext
  intro z
  rw [MvPolynomial.eval_specializeAt, MvPolynomial.eval_add,
    MvPolynomial.eval_mul, MvPolynomial.eval_C,
    MvPolynomial.eval_specializeZero]
  rw [hP.eval_update_eq_eval_pderiv_mul_add i z c]
  ring
