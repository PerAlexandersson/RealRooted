...
/-!
# Liu--Wang strict positive-lag regression examples

Sequence tests for strict positive `X` and scalar-`X` lag recurrences,
including interlacing, real-rootedness, and projection endpoints.
-/
