...
/-!
# OEIS derivative-lag router regression examples

Derivative-lag certificate router tests, including supplied and automatic
variants and the guarded expected-error contract.
-/
