...
/-!
# Product-family tactic regression examples

Smoke tests for repeated-root, scalar, affine, powered, finite-product,
periodic, and automatic product-family dispatchers.
-/
