...
This represents an acceptable trust boundary for the finite Borcea-Branden symbol preserver
route, which is a classic multivariate stability result whose formalization is out of scope. -/
