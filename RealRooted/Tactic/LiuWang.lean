...
macro_rules
  ...
  | `(tactic|
      ...
      `(tactic|
        first
          | refine RealRooted.prec_lw_negative_square_lag
  ...
  | `(tactic|
      ...
      `(tactic|
        first
          | refine RealRooted.prec_lw_negative_const_lag
              $hgf $hg_pos ?_ $hF_pos $hdeg_lo $hdeg_hi $hno
            rr_lw_coeff_nonneg
          | refine (by
              simpa using
  ...
  | `(tactic|
      ...
      `(tactic|
        first
          | refine RealRooted.prec_lw_negative_const_lag_C_neg
              $hgf $hg_pos ?_ $hF_pos $hdeg_lo $hdeg_hi $hno
            rr_lw_coeff_nonneg
          | refine (by
              simpa using
  ...
  | `(tactic|
      ...
      `(tactic|
        rr_exact_realrooted_sequence_or_projection
          (RealRooted.isRealRooted_of_lw_positive_t_lag_sequence
            $hbase $hpos $hnonneg (fun n => by rr_lw_active_nonneg_at n) $hrec
            $hdeg_succ $hno))
  | `(tactic|
      rr_lw_positive_X_lag_sequence using
        base := $hbase:term,
  ...
  | `(tactic|
      rr_lw_C_mul_X_sub_X_pow_three_lag_sequence_nonneg_auto using
        ...
        no_common_roots := $hno:term) =>
      `(tactic|
        refine RealRooted.prec_lw_C_mul_X_sub_X_pow_three_lag_sequence_of_nonneg_coeffs
          $hbase $hpos $hnonneg ?_ $hroot_lower $hrec $hdeg_succ $hno <;>
          intro n <;>
          rr_lw_active_nonneg_at n)
  | `(tactic|
