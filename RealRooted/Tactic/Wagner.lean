...
theorem wagner_commonRight_add_sequence {F G H : Nat → ℝ[X]}
    ...
    ∀ n : Nat, Prec (F n + G n) (H n) := fun n =>
  Challenges.Wagner.commonRight_add (hF n) (hG n) (hH n) (hFH n) (hGH n)
...
theorem wagner_commonLeft_add_sequence {F G H : Nat → ℝ[X]}
    ...
    ∀ n : Nat, Prec (H n) (F n + G n) := fun n =>
  Challenges.Wagner.commonLeft_add (hF n) (hG n) (hH n) (hHF n) (hHG n)
