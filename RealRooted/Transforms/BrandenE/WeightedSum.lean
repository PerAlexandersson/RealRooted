...
theorem brandenBasisWeightedSum_ne_zero_and_splits_of_pos
  ...
  have hcommon : HasCommonLeftInterleaver fs := by
    ...
    exact StrictInterl.C_mul_right
      (brandenBasisImage_zero_strictInterl n k (hkn k hk)) (ha k hk).ne'
...
theorem brandenBasisWeightedSum_interl_of_le
  ...
  · intro k hk
    exact Interl.C_mul_right_of_nonneg
      (brandenBasisImage_zero_strictInterl n k (hkn k hk)).toInterl (ha k hk)
  · intro k hk
    exact nonnegCoeffs_C_mul (ha k hk) (brandenBasisImage_nonneg n k)

/-- Compatibility wrapper retaining the former ambient-degree hypothesis. -/
theorem brandenBasisWeightedSum_interl
    (n : ℕ) (s : Finset ℕ) (a : ℕ → ℝ)
    (_hn : 3 ≤ n) (hkn : ∀ k ∈ s, k ≤ n)
    (ha : ∀ k ∈ s, 0 ≤ a k) :
    Interl (brandenBasisImage n 0) (brandenBasisWeightedSum n s a) :=
  brandenBasisWeightedSum_interl_of_le n s a hkn ha

/-- With at least one positive weight, the weak cone relation is strict. -/
theorem brandenBasisWeightedSum_strictInterl_of_le
    (n : ℕ) (s : Finset ℕ) (a : ℕ → ℝ)
    (hkn : ∀ k ∈ s, k ≤ n) (ha : ∀ k ∈ s, 0 ≤ a k)
    (hpos : ∃ k ∈ s, 0 < a k) :
    StrictInterl (brandenBasisImage n 0) (brandenBasisWeightedSum n s a) := by
  apply (brandenBasisWeightedSum_interl_of_le n s a hkn ha).toStrictInterl_of_ne
...
/-- Compatibility wrapper retaining the former ambient-degree hypothesis. -/
theorem brandenBasisWeightedSum_strictInterl
    (n : ℕ) (s : Finset ℕ) (a : ℕ → ℝ)
    (_hn : 3 ≤ n) (hkn : ∀ k ∈ s, k ≤ n)
    (ha : ∀ k ∈ s, 0 ≤ a k)
    (hpos : ∃ k ∈ s, 0 < a k) :
    StrictInterl (brandenBasisImage n 0) (brandenBasisWeightedSum n s a) :=
  brandenBasisWeightedSum_strictInterl_of_le n s a hkn ha hpos
