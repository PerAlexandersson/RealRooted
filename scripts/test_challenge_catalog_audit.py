#!/usr/bin/env python3
"""Focused source-only tests for the challenge catalog audit driver."""
...
class ChallengeCatalogAuditTests(unittest.TestCase):
    def test_audit_reuses_canonical_loader_and_digest(self) -> None:
        ...
        self.assertIs(audit.load_pages, challenge_catalog.load_catalog)
        self.assertIs(audit.catalog_digest, challenge_catalog.catalog_digest)
